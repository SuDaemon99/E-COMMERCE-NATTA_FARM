    ...
    <nav aria-label="breadcrumb">
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="file" name="foto" id="foto" class="form-control" value="Upload Image" name="submit" action="produk_detail.php">
            ...
            ?>
                                    <div class="alert alert-warning mt-3" role="alert">
                                        File wajib bertipe jpg atau png gif
                                    </div>
            <?php                            
                                }
                                else{
        ...
        <div class="mt-3 mb-5">
            ...
            <div class="text-center">
                <a href="laporan_produk.php" target="_blank" class="btn btn-primary"><i class="fa-solid fa-print"></i> Print</a>
                <a href="laporan_produk_excel.php" class="btn btn-success"><i class="fa-solid fa-download"></i> Download Excel</a>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="produk_detail.php?q=<?php echo $data['id']; ?>"
